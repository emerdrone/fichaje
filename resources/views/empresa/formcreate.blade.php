        ...
        <div class="col-lg-12">
            <div class="card-body">
                ...
                <div class="form-group col-lg-4">
                    ...
                    {!! Form::select('territorio_id', $territorios, $empresa->territorio_id, ['class' => 'form-control form-control-sm' . ($errors->has('territorio_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione Pais', 'id' => 'select-pais']) !!}
                ...
                <div class="form-group col-lg-4">
                    ...
                    {!! Form::select('localidad_id', ['placeholder' => 'Selecciona Localidad'], null, ['id' => 'select-localidad', 'class' => 'form-control form-control-sm' . ($errors->has('localidad_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione Provincia']) !!}
