                                        ...
                                        <tr>
                                            ...
                                            <td width="15%" class="text-center">
                                                <form action="{{ route('empresa.destroy',$empresa->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('empresa.show',$empresa->id) }}"><i class="fa fa-fw fa-eye"></i> </a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('empresa.edit',$empresa->id) }}"><i class="fa fa-fw fa-edit"></i> </a>
                                                    @csrf
                                                    @method('DELETE')
