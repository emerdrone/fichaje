                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">
                            ...
                            <a class="btn btn-default btn-sm" href="{{ route('user.restaurar') }}"><i class="fas fa-cog"></i></a>
                        </span>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.store') }}" role="form"
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus-circle mr-1"></i>Crear Usuario</button>
                            </div>
