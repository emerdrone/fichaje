                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">
                            ...
                            <a class="btn btn-default btn-sm" href="{{ route('localidad.restaurar') }}"><i class="fas fa-cog"></i></a>
                        </span>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('localidad.store') }}" role="form"
                            ...
                            <div class="box-footer mt20">
                                <button type="submit" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus-circle mr-1"></i>Crear Localidad</button>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Importar Localidads</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('localidad.excel') }}" method="POST" enctype="multipart/form-data">
                        @csrf
