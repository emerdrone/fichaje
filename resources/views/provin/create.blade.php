                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">
                            ...
                            <a class="btn btn-default btn-sm" href="{{ route('provin.restaurar') }}"><i class="fas fa-cog"></i></a>
                        </span>
                        <a class="btn btn-default btn-sm float-right" href="{{ route('provin.index') }}"> <i class="far fa-arrow-alt-circle-left"></i></a>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('provin.store') }}" role="form"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Importar Provincias</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('provin.excel') }}" method="POST" enctype="multipart/form-data">
                        @csrf
